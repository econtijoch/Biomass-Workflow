...
I am working on updating the documentation for the tutorial. So far, there is an introductory tutorial that will get you through generating a measurement of microbial density [here](http://eduardocontijoch.com/Projects/Biomass-Workflow/Vignettes/tutorial.html). Upcoming is a tutorial to walk through prepping samples for sequencing.
