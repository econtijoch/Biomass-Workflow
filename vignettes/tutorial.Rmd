...
```{r mass_and_order, eval=T, fig.path='figure/', message=FALSE, warning=FALSE, include=T, messages=F, results='hide'}

sample_masses <- mass_and_order('Sample_Empty_Weights.txt', 'Sample_Full_Weights.txt', order = 'Sample_Tube_Order_Scanned.csv')

```

```{r mass_and_order_output, message=FALSE, warning=FALSE}

pander::pandoc.table(sample_masses)
