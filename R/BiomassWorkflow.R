...
if (getRversion() >= "2.15.1") {
    utils::globalVariables(c("X.SampleID", "Taxon", "value", "absolute_abundance", "relative_abundance", "SampleMass", 
        ...
        'Full Mass', "Empty Mass", "rowname", "taxonomy", "Kingdom", 'total_dna', 'scale_factor', 'BR_dna_concentration', 'HS_dna_concentration', "i5_index", "i5_sequence", "i7_index", "i7_sequence", "dualIndex_i7_i5", "Full Weight", "Empty Weight", "Dry Weight", "Dried Weight", "Water Percentage", "Pellet Weight", "Dry Percentage")) 
}
