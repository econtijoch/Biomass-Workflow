...
Deprecated_StandardAnalysis <- function(standards_plate_reader_csv_file, standards_mapping_csv_file, exp_id) {
    ...
    rawdata <- Deprecated_ParsePlateReaderFile(standards_plate_reader_csv_file)
